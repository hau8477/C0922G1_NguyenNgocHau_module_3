...
<center>
    ...
    <form action="cardbook" class="d-flex" role="search" method="get">
        <input class="form-control me-2" type="search" placeholder="Tìm kiếm sách" aria-label="Search" name="searchBook">
        <input class="form-control me-2" type="search" placeholder="Tìm kiếm học sinh" aria-label="Search" name="searchStudent">
    ...
    <table id="tableStudent" class="table table-striped">
        ...
        <tbody>
        <c:forEach var="cardBook" items="${cardBooks}" varStatus="stt">
            <td>${stt.count}</td>
            <td>${cardBook.getIdBook()}</td>
            <td>${cardBook.getNameBook()}</td>
            <td>${cardBook.getNameHuman()}</td>
            <td>${cardBook.getNameStudent()}</td>
            <td>${cardBook.getClasses()}</td>
            <td>${cardBook.getDateStart()}</td>
            <td>${cardBook.getDateEnd()}</td>
            <td>
                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                        data-bs-target="#exampleModal12"><a href="student?action=edit&idEdit1="
