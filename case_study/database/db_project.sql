...
(
    ...
    teacher_code          varchar(45) unique not null ,
    teacher_name          varchar(50) not null ,
    teacher_date_of_birth varchar(255) not null ,
...
(
    student_announcement int auto_increment primary key,
    student_id           int,
    announcement_id      int,
...
(
    progress_report_id      int auto_increment primary key,
...
(
    question_and_answer_id      int primary key auto_increment,
...
(
    notification_teacher_id      int primary key auto_increment,
