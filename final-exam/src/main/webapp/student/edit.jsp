    ...
    <form action="student?action=create" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                   ...
                   title="Email chưa đúng định dạng" required value="${student.getEmail()}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail2" aria-describedby="emailHelp"
                   placeholder="VD: Nguyễn Văn An" name="phoneNumber" required value="${student.getPhoneNumber()}">
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail3" aria-describedby="emailHelp"
                   placeholder="VD: 10" name="point" required value="${student.getPoint()}">
        </div>
        <div class="mb-3">
